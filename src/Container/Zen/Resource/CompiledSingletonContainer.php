...
class CompiledSingletonContainer extends AbstractCompiledContainer
{
    ...
    {
        return $this->singletonEntries['Psr\Container\ContainerInterface'] = $this->singletonEntries['DiContainerBenchmarks\Container\Zen\Resource\CompiledSingletonContainer'] ?? $this->DiContainerBenchmarks__Container__Zen__Resource__CompiledSingletonContainer();
