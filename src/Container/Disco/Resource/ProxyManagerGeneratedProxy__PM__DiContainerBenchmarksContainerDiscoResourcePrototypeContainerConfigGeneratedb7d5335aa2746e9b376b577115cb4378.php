...
class Generatedb7d5335aa2746e9b376b577115cb4378 extends \DiContainerBenchmarks\Container\Disco\Resource\PrototypeContainerConfig implements \bitExpert\Disco\Proxy\Configuration\AliasContainerInterface
{

    /**
     * @var bool flag to toggle if a bean gets wrapped by a LazyProxy or not
     */
    private $forceLazyInit587dd278e0858060812526 = null;

    /**
     * @var bitExpert\Disco\Store\BeanStore
     */
    private $sessionBeans587dd278e0aa0029610677 = null;

    /**
     * @var bitExpert\Disco\BeanFactoryPostProcessor[]
     */
    private $postProcessors587dd278e0b1a794042733 = array(
     ...
     */
    private $parameterValues587dd278e0f82151976919 = array(
     ...
     */
    private $config587dd278e0feb456849576 = null;

    /**
     * @var array contains a list of aliases and their bean references
     */
    private $aliases587dd278e1047123958178 = array(
        
    );

    private static $signatureb7d5335aa2746e9b376b577115cb4378 = '';
    ...
    {
        $backupForceLazyInit = $this->forceLazyInit587dd278e0858060812526;
        ...
        foreach ($this->postProcessors587dd278e0b1a794042733 as $postProcessor) {
    ...
    {
        $this->parameterValues587dd278e0f82151976919 = $params;$this->config587dd278e0feb456849576 = $config;$this->sessionBeans587dd278e0aa0029610677 = $config->getSessionBeanStore();
        // register {@link \bitExpert\Disco\BeanPostProcessor} instances
        $this->postProcessors587dd278e0b1a794042733[] = new \bitExpert\Disco\BeanFactoryPostProcessor();
    }

    public function wrapBeanAsLazy($beanId, $beanType, $instance)
    {
        $factory = new \bitExpert\Disco\Proxy\LazyBean\LazyBeanFactory($beanId, $this->config587dd278e0feb456849576->getProxyManagerConfiguration());
    ...
    protected function getParameter($propertyName, $required = true, $defaultValue = null)
    {
        ...
        $value = $this->parameterValues587dd278e0f82151976919;
        $currentPath = [];
    ...
    {
        return ["sessionBeans587dd278e0aa0029610677"];
    }

    public function getAlias(string $alias)
    {
        if ($this->hasAlias($alias)) {
            $methodname = $this->aliases587dd278e1047123958178[$alias];
    ...
    {
        return !empty($alias) && isset($this->aliases587dd278e1047123958178[$alias]);
    }
